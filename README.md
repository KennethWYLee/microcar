...
`00_BootCamp` 保留為一小時快速體驗課入口，適合第一次上課時讓學生先用 Thonny 連接小車、貼上程式並完成前進、後退、左右轉與停止。它不是正式 01-08 主題的一部分。
...
- `bootcamp.html`：00_BootCamp 快速體驗課。
...
第一次上課先使用 `00_BootCamp`，讓學生建立「電腦連到小車、程式貼上去、小車會動」的成功經驗。後續課程再依序進入 01-05 主題建立小車能力，最後用 06-08 主題延伸到藍芽遙控、電路板導讀與擺頭電扇作品應用。
