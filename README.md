...
- `firmware.html`：Firmware 區，提供 Pico / Pico W / Pico 2 / Pico 2 W 對應的 UF2 韌體、履帶車韌體包、對應表與刷機步驟。
...
- `downloads/firmware/track_car_firmware.zip`
...
5. `track_car_firmware.zip`：履帶車韌體包，zip 內含 `firmware.uf2`
